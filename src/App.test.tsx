...
describe("App settings form", () => {
  ...
  it("shows added pension lump sums in the simple journey added pension step", () => {
    ...
    expect(
      screen.getByRole("heading", { name: "Added pension lump sums" })
    ).toBeInTheDocument();
    expect(
  ...
  it("renders sensible default values", async () => {
    ...
    expect(
      screen.getByRole("heading", { name: "Calculated details" })
    ).toBeInTheDocument();
    expect(
    ...
    expect(
      screen.getByRole("link", { name: "Check State Pension age" })
    ).toHaveAttribute("href", "https://www.gov.uk/state-pension-age");
    expect(
  ...
  it("shows validation guidance and pauses the projection when stored settings are inconsistent", async () => {
    ...
    expect(
      screen.getByRole("heading", { name: "Check these assumptions" })
    ).toBeInTheDocument();
    expect(

...
describe("App settings form", () => {
  ...
  it("renders sensible default values", () => {
    ...
    expect(screen.getByLabelText("Last Alpha Annual Benefits Statement")).toHaveValue(
      "2025",
    );
    expect(
    ...
    expect(
      screen.getByRole("link", { name: "Last Alpha Annual Benefits Statement information" }),
    ).toHaveAttribute(
      "href",
  ...
  it("updates settings and saves to local storage", () => {
    ...
    const absDateInput = screen.getByLabelText("Last Alpha Annual Benefits Statement");
  ...
  it("stores the Alpha ABS date as just the selected year", () => {
    ...
    fireEvent.change(screen.getByLabelText("Last Alpha Annual Benefits Statement"), {
      target: { value: "2024" },
    });

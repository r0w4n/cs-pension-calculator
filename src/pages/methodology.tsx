    ...
    >
      <section>
        ...
        <p className="section-copy">
          The modeller builds a month-by-month projection from your chosen start
          date to the selected life expectancy date. Each month updates pension
          accrual and, once a draw date is reached, includes the relevant income
          streams in the totals.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="section-copy">
          Where the modeller needs a real return, it converts nominal investment
          returns using compound inflation adjustment rather than simple
          subtraction.
        </p>
        <p className="section-copy">
        ...
        <p className="section-copy">
          For example, 5% nominal growth with 2.5% inflation gives a real return
          of about 2.44%.
        </p>
      </section>
      ...
      <section>
        <h2>Assumptions</h2>
        <p className="section-copy">
          This section covers externally governed or user-entered assumptions
          used by the projection, including State Pension age, State Pension
          deferral, Alpha early-retirement assumptions, nuvos assumptions, and
          minimum pension access age.
        </p>
        <p className="section-copy">
          Calculations depend on the assumptions you enter (for example accrual,
          draw ages, contribution rates, inflation, and growth settings). Where
          defaults exist, they are intended as a starting point rather than a
          recommendation.
        </p>
        <p className="section-copy">
